...
public class RefreshTokenUseCase implements RefreshTokenInBound {
    ...
    public JwtResponse refresh(String refreshToken) {
        ...
        var user = userRepository.getById(claims.getUserId());
        var device = deviceRepository.findById(claims.getDeviceId())
        ...
        var tokens = jwtService.generateAccessRefreshTokens(user.getUsername(), user.getId(), device.getId());
